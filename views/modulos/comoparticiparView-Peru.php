...
<div id="app" class="main-container main-background">
  <section class="p-0 pb-3">
    <div class="container">
      ...
      <div class="row flex-md-row card card-lg border-0 mb-0 justify-content-md-center bg-transparent">
        ...
        <div class="col-12 col-md-5">
          <img alt="Image" src="assets/img/MECANICA-PROMO-MUEVETE-VERDE_PERU.png" class="w-100" />
        </div>
